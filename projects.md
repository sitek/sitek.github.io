...
I have a strong interest in [subcortical auditory structures](#mapping-the-human-subcortical-auditory-system), which are understudied in humans due to technical challenges. I use ultra-high field MRI (7T and above) and post mortem imaging to overcome these challenges and to bridge the gap between animal models and human neuroimaging.
